...
function PageQRCode({ qrContent, valorDebitos,dtcriacaotransacao, tempoRestanteSegundos, qtdDebitos}) {
    ...
    return (
      <div className="background-container">
        ...
        <ExibicaoQRCode qrContent={qrContent} />
          <div className="value-text">Valor: R${valorDebitos}<br /></div>
          <div class="debit-text">Quantidade de débitos: {qtdDebitos}</div>
          <button className="copy-button"  onClick={copyToClipboard} id="copyBtn">Copiar QR Code</button>
          {showNotification && (
